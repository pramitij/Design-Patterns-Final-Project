        ...
        <React.Fragment>
            <Container fluid="lg">
                <Row className="container-main">
                    <Col lg={6}>
                        <h3 className="center-align">Add Order</h3>
                    </Col>
                </Row>
                ...
                <Row className="container-main">
                    <Col md={{span : 10, offset : 1}}>
                        <Card>
                            ...
                            <Row>
                                <Col lg={6}>
                                        <FloatingLabel controlId="floatingSelect" label="Select Member">
                            ...
                            <Row>
                                    <Col lg={5}>
                                        <FloatingLabel controlId="floatingSelect" label="Select Merchandise">
                                            <Form.Select aria-label="Product List" onChange={handleProductChangne}>
                                            <option value="" selected disabled>Select a Merchandise</option>
                            ...
                            <tbody>
                                {selectedProducts.map((product, index) => {
                                    ...
                                    return (<tr key={id}>
                                        ...
                                        <td>
                                            <FontAwesomeIcon onClick={()=>deleteProduct(product)} icon={faTrash} style={{color: "#ff0000",}} />
                                        </td>
                                    </tr>);
                                })}      
                                </tbody>
