        ...
        if (validateInputField({field : ownerName, fieldName : "owner name"}) && 
            ...
            axios[isUpdate ? "put" : "post"](url, body)
              .then(function (response) {
                ...
                if(status === 200){
                    resetForm();
                    displayToast({type : "success", msg : `${isUpdate ? ownerName + ' updated' : 'Customer added'} successfully!`});
                    setIsLoading(false);
                    setTimeout(() => {
        ...
        <React.Fragment>
            <Container fluid="lg">
                <Row className="container-main">
                    <Col>
                        <h3 className="center-align">{isUpdate ? "Update" : "Add"} Member Details</h3>
                    </Col>
                </Row>
                <Row className="container-main">
                         ...
                         <Card.Body>
                            <Form onSubmit={submitForm}>
                                <Form.Group className="mb-3" controlId="formBasicownerName">
                                    ...
                                    <Form.Control type="text" value={ownerName} onChange={handleOwnerNameChange} placeholder="Enter Customer Name" />
                                </Form.Group>

                                <Form.Group className="mb-3" controlId="formBasicCompanyName">
                                    <Form.Label>Address</Form.Label>
                                    <Form.Control type="text" value={companyName} onChange={handleCompanyNameChange} placeholder="Enter Address" />
                                </Form.Group>
